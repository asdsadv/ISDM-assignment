...
|Main Flow|1.	The relationship manager selects the correct holiday package 2.	The relationship manager confirms the selection for the specific customer 3.	The customer is asked to confirm if they want to purchase the holiday package 4.	The relationship manager is notified of the customers decision 5.	The use case ends|
